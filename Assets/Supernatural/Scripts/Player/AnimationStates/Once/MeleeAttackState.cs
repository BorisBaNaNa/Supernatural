...
{
    public class MeleeAttackState : SpineAnimationStateBase<PlayerAttackAnimationsReferences>
    {
        private Action _attackAction;

        private const string ATTACK_EVENT_NAME = "Attack";

        public MeleeAttackState(PlayerAttackAnimationsReferences animationsReferences, Action attackAction) : base(animationsReferences)
        {
        ...
        {
            SpineSwitcher.SetAnimation(_animationsReferences.MeleeAttackAnim, false, true);
